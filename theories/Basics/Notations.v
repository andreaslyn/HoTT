...
Reserved Notation "'CAT' \\ a" (at level 40, left associativity).
Reserved Notation "C ^op" (at level 3, left associativity, format "C '^op'").
...
Reserved Notation "m ^-1" (at level 3, left associativity, format "m '^-1'").
...
Reserved Notation "p ^" (at level 3, left associativity, format "p '^'").
...
Reserved Notation "T ^op" (at level 3, left associativity, format "T ^op").
